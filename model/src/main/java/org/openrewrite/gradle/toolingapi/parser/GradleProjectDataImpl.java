...
class GradleProjectDataImpl implements GradleProjectData, Serializable {
    ...
    static GradleProjectDataImpl from(Project project) {
        GradleProject gradleProjectMarker = GradleToolingApiProjectBuilder.gradleProject(project);
        return new GradleProjectDataImpl(
                gradleProjectMarker.getName(),
                gradleProjectMarker.getPath(),
                gradleProjectMarker.getGroup(),
                gradleProjectMarker.getVersion(),
                gradleProjectMarker.getPlugins(),
                gradleProjectMarker.getMavenRepositories(),
                gradleProjectMarker.getMavenPluginRepositories(),
                gradleProjectMarker.getNameToConfiguration(),
                GradleVersion.current().compareTo(GradleVersion.version("4.4")) >= 0 ? GradleToolingApiSettingsBuilder.gradleSettings(((DefaultGradle)project.getGradle()).getSettings()) : null,
